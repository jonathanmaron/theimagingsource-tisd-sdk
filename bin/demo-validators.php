...
$validator = new UniqueIdValidator(['locale' => 'de_DE', 'context' => TisdSdk::CONTEXT_ASTRONOMY]);
var_dump($validator->isValid('6595e5055d'));

$validator = new UniqueIdValidator(['locale' => 'en_US', 'context' => TisdSdk::CONTEXT_ASTRONOMY]);
var_dump($validator->isValid('6595e5055d'));
